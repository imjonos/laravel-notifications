...
Route::middleware('web', 'auth')->group(function () {
    ...
    Route::patch('/users/{id}/notifications/read-all', '\CodersStudio\Notifications\Http\Controllers\NotificationsController@readAll')->name('codersstudio.notifications.readall');
